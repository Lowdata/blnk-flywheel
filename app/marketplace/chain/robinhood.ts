...
/** Live by default: real wallet, real holdings. Set NEXT_PUBLIC_BLNK_MODE=mock for
 *  the offline fixture mode used during design work. */
export const BLNK_MODE = (process.env.NEXT_PUBLIC_BLNK_MODE ?? "live") as "mock" | "live";
...
export const RPC_URL: string = process.env.NEXT_PUBLIC_RPC_URL || PUBLIC_RPC_URL;
