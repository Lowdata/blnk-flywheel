...
/** OpenSea's logomark. lucide has no brand icons, so the official path is
 *  inlined — no runtime request, and it inherits colour like every other icon. */
export function OpenSeaIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
