...
export default function App() {
  ...
  return (
    <div className="min-h-screen lg:h-screen w-full flex flex-col lg:overflow-hidden blnk-grid" style={{ backgroundColor: PALETTE.bg }}>
      ...
      <main className="flex-1 flex flex-col lg:min-h-0 max-w-[1600px] w-full mx-auto px-5 py-4">
        ...
        {/* Three columns pinned to the viewport at lg and up. Below that they
            stack and the page scrolls — holding them to a short viewport
            clips every section into a sliver. */}
